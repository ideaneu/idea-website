...
function scout_base_scripts() {
    ...
    wp_enqueue_script( 'rsg-nav', get_template_directory_uri() . '/js/waypoints.min.js', array(), '');
      ...
      array(
            ...
            'rewrite' => array( 'slug' => 'team_type' )
                ...
                register_post_type( 'idea_partners',
                   ...
                   register_taxonomy('partner',
      array( 'idea_partners' ),
      array(
                        'hierarchical' => true,
                        'labels' => array(
                                'name' => _x( 'Partner or Service Provider', 'taxonomy general name' ),
                                'menu_name' => __( 'Partner or Service Provider' ),
                        ),
                        'show_ui' => true,
            'query_var' => true,
