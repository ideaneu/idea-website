...
<div class="container">
	...
	<div id="news-post-sidebar" class="col-xs-12 col-sm-12 col-md-3 col-lg-3"> <!-- The Sidebar with Category, tags, and search -->
          <hr>
          	<a href="/idea/news"><-- Back to Recent News</a>
          	<br><br>
          	<p> TAGS </p>
            <div class="postclass">
			...
			<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				<div class="post-header">
					...
					<h4 id="post-date"><?php scout_base_posted_on(); ?></h4>
					 <?php the_tags( '<p class="posttag_header">', ',</p> <p class="posttag_header">', '</p>' ); ?>
				</div>
