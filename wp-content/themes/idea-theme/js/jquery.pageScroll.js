    ...
    $.fn.pageScroll = function(options) {
        ...
        if (settings.pagination) {
            ...
            if (!$pagination.length) {
                ...
                $('#scroll-container').prepend($pagination);
            }
        ...
        $el.on('touchstart', function(e) {
            if ($("#scroll-container").hasClass("disable-page-scroll")) {
                return false;
            }
        ...
        if (settings.keyboard) {
            $doc.on('keydown', function(e) {
                ...
                if (tag === 'input' || tag === 'textarea' || $("#scroll-container").hasClass("disable-page-scroll")) {
                    return;
                }
                switch (e.which) {
                    case 38:
